...
Framework focus: LangGraph, LangChain, OpenAI Agents SDK.
Pattern idea: Ein Agent erstellt zuerst einen Plan und arbeitet die Schritte danach kontrolliert ab."""
