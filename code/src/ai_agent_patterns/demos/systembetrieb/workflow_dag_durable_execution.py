"""Workflow DAG / Durable Execution demo.
...
Framework focus: LangGraph, Temporal, AWS Strands Workflow.
Pattern idea: Workflows laufen als persistenter Graph mit Retry und Wiederaufnahme."""
